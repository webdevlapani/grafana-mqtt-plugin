...
export class QueryEditor extends PureComponent<Props, State> {
  ...
  onInputChange = (what: string, run_query?: boolean) => (event: ChangeEvent<HTMLInputElement>) => {
  ...
  onIntInputChange = (what: string, run_query?: boolean) => (event: ChangeEvent<HTMLInputElement>) => {
    const { onChange, query, onRunQuery } = this.props;
          ...
          <>
            ...
            <div className="gf-form" style={{ flexWrap: 'wrap' }}>
              <FormField
                ...
                onChange={this.onInputChange('csv_field_delimiter', true)}
              ...
              <FormField
                ...
                onChange={this.onInputChange('csv_quote_character', true)}
              ...
              <FormField
                ...
                onChange={this.onInputChange('csv_quote_escape_character', true)}
              ...
              <FormField
                ...
                inputWidth={5}
                value={csv_comments}
                onChange={this.onInputChange('csv_comments', true)}
                label="Comments"
              ...
              <FormField
                ...
                onChange={this.onInputChange('csv_record_delimiter', true)}
